...
class Calendar {     
    ...
    */
    private function _showDay($cellNumber){
        ...
        $dateformat = '<a href="spservice.php?dayis='.$this->currentDate.'&type='.$servtype.'" target="_top"><li id="li-'.$this->currentDate.'" class="'.($cellNumber%7==1?' start ':($cellNumber%7==0?' end ':' ')).
