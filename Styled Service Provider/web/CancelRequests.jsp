    ...
    <body>
       ...
       <div class="container-fluid">
           <div class="row-fluid">
                <div class="span2">
                    <div class="col-sm-3 col-md-2">
                        <ul class="nav nav-pills nav-stacked sidebar">
                            ...
                            <li class="active"><a href="CancelRequests.jsp">Cancel Requests</a></li>
                ...
                <div class="span10">
                   <h3 class="secondPageHeader">Cancel Requests</h3>
                            ...
                            <table class="table table-striped table-hover">
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="submit" class="btn btn-danger" name="cancel" value="Cancel"></td>
                                    </tr>
                                    </c:forEach>
                            </table>
                        </form>
